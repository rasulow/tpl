                        ...
                        <v-col>
                          ...
                          >
                            <v-card-title 
                              ...
                              {{ item.name }}
                              <span class="category-badge">{{ item.objects__count }}</span>
                            </v-card-title>
                          </router-link>
                          </v-row>
                        </v-col>
                    ...
                    <v-row no-gutters justify="center">
                      ...
                      <v-row no-gutters justify="center" style="margin-top: 10px;">
                        <div class="phone-number-div">
                          ...
                          <input type="tel" class="input" v-model="phoneValue">
                        </div>
                      </v-row>
  ...
  import is_have from '@/utils/haveToken'
    export default {
      ...
      methods: {
        ...
        async phoneAuth() {
          console.log(typeof parseInt(this.phoneValue))
          await axios.post('/code/phone/', { phone: parseInt(this.phoneValue) })
            .then(response => {
              console.log(response.data)
              this.step = 3
            })
        ...
        checkToken(tab) {
          if(is_have())
          {
            this.$router.push('/publications/favorites?tab=' + tab)
          }else{
            this.dialog = true
          }
        }
